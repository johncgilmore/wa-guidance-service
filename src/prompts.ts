 ...
 */
export const WA_CHAT_DISCLAIMER =
  'This is just from reviewing the most recent Washington interim guidance. It is not tax or financial advice—only a direct summary of the cited language.';
 ...
 */
export function buildSystemPrompt(guidanceContext: string): string {
...
• Always finish your response with this disclaimer: ${WA_CHAT_DISCLAIMER}
