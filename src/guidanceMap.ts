 ...
 */
export const GUIDANCE_BY_TILE: Record<WaTileId, GuidanceEntry[]> = {
  it: [
    {
  ...
  security: [
    {
      ...
      label:
        'Interim Guidance — Investigation, Security, Security Monitoring, and Armored Car (ESSB 5814)',
    },
  ],
  presentations: [
    {
 ...
 */
export const GUIDANCE_SHARED: GuidanceEntry[] = [
  {
 ...
 */
export function isWaTileId(value: unknown): value is WaTileId {
  return typeof value === 'string' && Object.prototype.hasOwnProperty.call(GUIDANCE_BY_TILE, value);
}
